...
single human operator and a team of AI agents (Claude Opus 4.7, GPT-5.4 xhigh,
...
- L1 architecture & hard bugs → **Opus 4.7** (extended thinking)
- L2 planning / spec → Opus 4.7 plan mode, or GPT-5.4 xhigh
- L3 reviews → **GPT-5.4** via codex-plugin-cc
- L4 build → **Sonnet 4.6** (default) or GPT-5.3-Codex
- L5 boilerplate → Haiku 4.5 / GPT-5.4-mini / Codex-Spark
...
## Prohibited
- Auto-generating `AGENTS.md` or `CLAUDE.md` (LLM-generated context files hurt quality per ETH 2026)
...
Keep this file under 150 lines. Every instruction here loads into every session.
